...
// import com.xmjz.echarts.nativebean.option.*;
// import com.xmjz.echarts.nativebean.option.legend.Data;
//
...
//
//     private Optioner(Option option) {
//         this.option = Objects.requireNonNull(option);
//     }
//
//     public static Optioner load(Option option) {
//         return new Optioner(option);
//     }
//
...
//     }
//
//     public Optioner textLegend(String legendText) {
//         option.setLegend(new Legend().setData(Collections.singletonList(new Data().setName("高度(km)与气温(°C)变化关系"))));
//         return this;
//     }
//
//     /**
...
//      * @return this
//      */
//     public Optioner addSeries(Series series) {
