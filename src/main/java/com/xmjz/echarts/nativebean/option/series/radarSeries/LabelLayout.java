...
public class LabelLayout extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.hideOverlap">#series-radar.labelLayout.hideOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否隐藏重叠的标签。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.moveOverlap">#series-radar.labelLayout.moveOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.x">#series-radar.labelLayout.x</a>
     * <br/>默认值: 无
    ...
    private Object x;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.y">#series-radar.labelLayout.y</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","string"]
     * <br/>描述:
    ...
    private Object y;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.dx">#series-radar.labelLayout.dx</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dx;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.dy">#series-radar.labelLayout.dy</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dy;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.rotate">#series-radar.labelLayout.rotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签旋转角度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.width">#series-radar.labelLayout.width</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.height">#series-radar.labelLayout.height</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签显示的高度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.align">#series-radar.labelLayout.align</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.verticalAlign">#series-radar.labelLayout.verticalAlign</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.fontSize">#series-radar.labelLayout.fontSize</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.draggable">#series-radar.labelLayout.draggable</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.labelLayout.labelLinePoints">#series-radar.labelLayout.labelLinePoints</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标签引导线三个点的位置。格式为：</p>
