...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle">#series-graph.data.select.itemStyle</a>
 * <br/>默认值: 无
 * <br/>js类型: ["Object"]
 * <br/>描述:
 *
...
public class ItemStyle extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.color">#series-graph.data.select.itemStyle.color</a>
     * <br/>默认值: 自适应
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>图形的颜色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderColor">#series-graph.data.select.itemStyle.borderColor</a>
     * <br/>默认值: '#000'
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderWidth">#series-graph.data.select.itemStyle.borderWidth</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>描边线宽。为 0 时无描边。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderType">#series-graph.data.select.itemStyle.borderType</a>
     * <br/>默认值: 'solid'
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderDashOffset">#series-graph.data.select.itemStyle.borderDashOffset</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderCap">#series-graph.data.select.itemStyle.borderCap</a>
     * <br/>默认值: 'butt'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderJoin">#series-graph.data.select.itemStyle.borderJoin</a>
     * <br/>默认值: 'bevel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.borderMiterLimit">#series-graph.data.select.itemStyle.borderMiterLimit</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.shadowBlur">#series-graph.data.select.itemStyle.shadowBlur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.shadowColor">#series-graph.data.select.itemStyle.shadowColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.shadowOffsetX">#series-graph.data.select.itemStyle.shadowOffsetX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影水平方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.shadowOffsetY">#series-graph.data.select.itemStyle.shadowOffsetY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影垂直方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.data.select.itemStyle.opacity">#series-graph.data.select.itemStyle.opacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
