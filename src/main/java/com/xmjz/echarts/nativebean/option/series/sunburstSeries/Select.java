...
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.select.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.select.Label;
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.select.LabelLine;
...
public class Select extends BaseEcharts implements Serializable {
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.select.labelLine">#series-sunburst.select.labelLine</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标签的视觉引导线配置。</p>
