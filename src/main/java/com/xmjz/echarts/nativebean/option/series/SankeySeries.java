...
import com.xmjz.echarts.nativebean.option.series.sankeySeries.*;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey">#series-sankey</a>
 * <br/>默认值: 无
 * <br/>js类型: ["object"]
 * <br/>描述:
 ...
 * <iframe data-src="https://echarts.apache.org/examples/zh/view.html?c=sankey-energy&amp;edit=1&amp;reset=1" width="700" height="580" data-ll-timeout="26"></iframe>
 *
 *
 * <p><br>
 ...
 * <p><br>
 * <strong>排序：</strong></p>
 * <p>如果想指定每层节点的顺序是按照 <a href="https://echarts.apache.org/zh/option.html#series-sankey.data">data</a> 中的顺序排列的。可以设置 <a href="https://echarts.apache.org/zh/option.html#series-sankey.layoutIterations">layoutIterations</a> 为 <code class="codespan">0</code>。</p>
 *
 * @author auto
 */
@Getter
...
public class SankeySeries extends Series implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.type">#series-sankey.type</a>
     * <br/>默认值: 'sankey'
     * <br/>js类型: ["string"]
     * <br/>描述:
     */
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.id">#series-sankey.id</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String id;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.name">#series-sankey.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.zlevel">#series-sankey.zlevel</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>所有图形的 zlevel 值。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.z">#series-sankey.z</a>
     * <br/>默认值: 2
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer z;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.left">#series-sankey.left</a>
     * <br/>默认值: 5%
    ...
    private Object left;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.top">#series-sankey.top</a>
     * <br/>默认值: 5%
     * <br/>js类型: ["string","number"]
     * <br/>描述:
    ...
    private Object top;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.right">#series-sankey.right</a>
     * <br/>默认值: 20%
     * <br/>js类型: ["string","number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.bottom">#series-sankey.bottom</a>
     * <br/>默认值: 5%
     * <br/>js类型: ["string","number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.width">#series-sankey.width</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string","number"]
     * <br/>描述:
     * <p>sankey组件的宽度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.height">#series-sankey.height</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string","number"]
     * <br/>描述:
     * <p>sankey组件的高度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.nodeWidth">#series-sankey.nodeWidth</a>
     * <br/>默认值: 20
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>桑基图中每个矩形节点的宽度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.nodeGap">#series-sankey.nodeGap</a>
     * <br/>默认值: 8
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.nodeAlign">#series-sankey.nodeAlign</a>
     * <br/>默认值: 'justify'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.layoutIterations">#series-sankey.layoutIterations</a>
     * <br/>默认值: 32
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>布局的迭代次数，目的是不断迭代优化图中节点和边的位置，以减少节点和边之间的相互遮盖，默认值是 <code class="codespan">32</code>。如果希望图中节点的顺序是按照原始 <a href="https://echarts.apache.org/zh/option.html#series-sankey.data">data</a> 中的顺序排列的，可设该值为 <code class="codespan">0</code>。</p>
     */
    private Integer layoutIterations;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.orient">#series-sankey.orient</a>
     * <br/>默认值: 'horizontal'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.draggable">#series-sankey.draggable</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.label">#series-sankey.label</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout">#series-sankey.labelLayout</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.itemStyle">#series-sankey.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>桑基图节点矩形的样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.lineStyle">#series-sankey.lineStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>桑基图边的样式</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.emphasis">#series-sankey.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>桑基图的高亮状态。</p>
    ...
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.select">#series-sankey.select</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
     * <p>从 <code class="codespan">v5.0.0</code> 开始支持</p>
     * </blockquote>
     * <p>桑基图的选中状态。开启 <a href="https://echarts.apache.org/zh/option.html#series-sankey.selectedMode">selectedMode</a> 后有效。</p>
     */
    private Select select;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.selectedMode">#series-sankey.selectedMode</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.nodes">#series-sankey.nodes</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>同 <a href="https://echarts.apache.org/zh/option.html#series-sankey.data">data</a></p>
     */
    private List<?> nodes;
    /**
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.edges">#series-sankey.edges</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>同 <a href="https://echarts.apache.org/zh/option.html#series-sankey.links">links</a></p>
     */
    private List<?> edges;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.silent">#series-sankey.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animation">#series-sankey.animation</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationThreshold">#series-sankey.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationDuration">#series-sankey.animationDuration</a>
     * <br/>默认值: 1000
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationEasing">#series-sankey.animationEasing</a>
     * <br/>默认值: 'linear'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationDelay">#series-sankey.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationDurationUpdate">#series-sankey.animationDurationUpdate</a>
     * <br/>默认值: 300
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationEasingUpdate">#series-sankey.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.animationDelayUpdate">#series-sankey.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.tooltip">#series-sankey.tooltip</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
