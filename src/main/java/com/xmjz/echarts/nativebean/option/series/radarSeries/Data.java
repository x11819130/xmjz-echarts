...
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.AreaStyle;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.Blur;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.Emphasis;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.Label;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.LineStyle;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.Select;
import com.xmjz.echarts.nativebean.option.series.radarSeries.data.Tooltip;
...
public class Data extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.name">#series-radar.data.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据项名称</p>
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.value">#series-radar.data.value</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>单个数据项的数值。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.groupId">#series-radar.data.groupId</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.symbol">#series-radar.data.symbol</a>
     * <br/>默认值: 'circle'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>单个数据标记的图形。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.symbolSize">#series-radar.data.symbolSize</a>
     * <br/>默认值: 4
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.symbolRotate">#series-radar.data.symbolRotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.symbolKeepAspect">#series-radar.data.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.symbolOffset">#series-radar.data.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.itemStyle">#series-radar.data.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>单个拐点标志的样式设置。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.lineStyle">#series-radar.data.lineStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>单项线条样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.areaStyle">#series-radar.data.areaStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>单项区域填充样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-radar.data.tooltip">#series-radar.data.tooltip</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
