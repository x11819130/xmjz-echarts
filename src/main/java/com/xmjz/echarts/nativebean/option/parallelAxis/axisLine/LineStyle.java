package com.xmjz.echarts.nativebean.option.parallelAxis.axisLine;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle">#parallelAxis.axisLine.lineStyle</a>
 * <br/>默认值: 无
 * <br/>js类型: ["Object"]
 * <br/>描述:
 *
...
public class LineStyle extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.color">#parallelAxis.axisLine.lineStyle.color</a>
     * <br/>默认值: '#333'
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>坐标轴线线的颜色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.width">#parallelAxis.axisLine.lineStyle.width</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>坐标轴线线宽。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.type">#parallelAxis.axisLine.lineStyle.type</a>
     * <br/>默认值: 'solid'
    ...
    private Object type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.dashOffset">#parallelAxis.axisLine.lineStyle.dashOffset</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.cap">#parallelAxis.axisLine.lineStyle.cap</a>
     * <br/>默认值: 'butt'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String cap;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.join">#parallelAxis.axisLine.lineStyle.join</a>
     * <br/>默认值: 'bevel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String join;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.miterLimit">#parallelAxis.axisLine.lineStyle.miterLimit</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.shadowBlur">#parallelAxis.axisLine.lineStyle.shadowBlur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.shadowColor">#parallelAxis.axisLine.lineStyle.shadowColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.shadowOffsetX">#parallelAxis.axisLine.lineStyle.shadowOffsetX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影水平方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.shadowOffsetY">#parallelAxis.axisLine.lineStyle.shadowOffsetY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影垂直方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#parallelAxis.axisLine.lineStyle.opacity">#parallelAxis.axisLine.lineStyle.opacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
