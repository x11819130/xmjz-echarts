...
import com.xmjz.echarts.nativebean.option.series.lineSeries.markPoint.Blur;
import com.xmjz.echarts.nativebean.option.series.lineSeries.markPoint.Data;
import com.xmjz.echarts.nativebean.option.series.lineSeries.markPoint.Emphasis;
import com.xmjz.echarts.nativebean.option.series.lineSeries.markPoint.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.lineSeries.markPoint.Label;
...
public class MarkPoint extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.symbol">#series-line.markPoint.symbol</a>
     * <br/>默认值: 'pin'
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.symbolSize">#series-line.markPoint.symbolSize</a>
     * <br/>默认值: 50
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.symbolRotate">#series-line.markPoint.symbolRotate</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.symbolKeepAspect">#series-line.markPoint.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.symbolOffset">#series-line.markPoint.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.silent">#series-line.markPoint.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.itemStyle">#series-line.markPoint.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标注的样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.emphasis">#series-line.markPoint.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标注的高亮样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.blur">#series-line.markPoint.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
    ...
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data">#series-line.markPoint.data</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标注的数据数组。每个数组项是一个对象，有下面几种方式指定标注的位置。</p>
     * <ol>
     * <li>通过 <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data.x">x</a>, <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data.y">y</a> 属性指定相对容器的屏幕坐标，单位像素，支持百分比。</li>
     * </ol>
     * <ol start="2">
     * <li><p>用 <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data.coord">coord</a> 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 <code class="codespan">'min'</code>, <code class="codespan">'max'</code>, <code class="codespan">'average'</code>。</p>
     * </li>
     * <li><p>直接用 <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data.type">type</a> 属性标注系列中的最大值，最小值。这时候可以使用 <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data.valueIndex">valueIndex</a> 或者 <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.data.valueDim">valueDim</a> 指定是在哪个维度上的最大值、最小值、平均值。</p>
     * </li>
     * </ol>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animation">#series-line.markPoint.animation</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationThreshold">#series-line.markPoint.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationDuration">#series-line.markPoint.animationDuration</a>
     * <br/>默认值: 1000
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationEasing">#series-line.markPoint.animationEasing</a>
     * <br/>默认值: 'cubicOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationDelay">#series-line.markPoint.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationDurationUpdate">#series-line.markPoint.animationDurationUpdate</a>
     * <br/>默认值: 300
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationEasingUpdate">#series-line.markPoint.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-line.markPoint.animationDelayUpdate">#series-line.markPoint.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
