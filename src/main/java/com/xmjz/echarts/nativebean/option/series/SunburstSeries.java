...
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.*;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst">#series-sunburst</a>
 * <br/>默认值: 无
 * <br/>js类型: ["object"]
 * <br/>描述:
 * <p><a href="https://en.wikipedia.org/wiki/Pie_chart#Ring_chart_/_Sunburst_chart_/_Multilevel_pie_chart" target="_blank">旭日图（Sunburst）</a>由多层的环形图组成，在数据结构上，内圈是外圈的父节点。因此，它既能像<a href="https://echarts.apache.org/zh/option.html#series-pie">饼图</a>一样表现局部和整体的占比，又能像<a href="https://echarts.apache.org/zh/option.html#series-treemap">矩形树图</a>一样表现层级关系。</p>
 * <p><strong>示例：</strong></p>
 * <iframe data-src="https://echarts.apache.org/examples/zh/view.html?c=sunburst-monochrome&amp;edit=1&amp;reset=1" width="700" height="500" data-ll-timeout="25"></iframe>
 * <p>
 * <p>
 * <iframe data-src="https://echarts.apache.org/examples/zh/view.html?c=sunburst-drink&amp;edit=1&amp;reset=1" width="700" height="700" data-ll-timeout="26"></iframe>
 *
 *
 * <p><strong>数据下钻</strong></p>
 * <p>旭日图默认支持数据下钻，也就是说，当用户点击了某个扇形块之后，将会以该节点作为根结点显示，并且在中间出现一个返回上层节点的圆。如果不希望有数据下钻功能，可以通过将 <a href="https://echarts.apache.org/zh/option.html#series-treemap.nodeClick">series-sunburst.nodeClick</a> 设置为 <code class="codespan">false</code> 实现。</p>
 *
 * @author auto
 */
@Getter
...
public class SunburstSeries extends Series implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.type">#series-sunburst.type</a>
     * <br/>默认值: 'sunburst'
     * <br/>js类型: ["string"]
     * <br/>描述:
     */
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.id">#series-sunburst.id</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String id;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.name">#series-sunburst.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.zlevel">#series-sunburst.zlevel</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>所有图形的 zlevel 值。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.z">#series-sunburst.z</a>
     * <br/>默认值: 2
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer z;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.center">#series-sunburst.center</a>
     * <br/>默认值: ['50%', '50%']
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    private List<?> center;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.radius">#series-sunburst.radius</a>
     * <br/>默认值: [0, '75%']
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.labelLayout">#series-sunburst.labelLayout</a>
     * <br/>默认值: 无
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.labelLine">#series-sunburst.labelLine</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标签的视觉引导线配置。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle">#series-sunburst.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>旭日图扇形块的样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.nodeClick">#series-sunburst.nodeClick</a>
     * <br/>默认值: 'rootToNode'
     ...
     * <li><code class="codespan">'link'</code>：如果节点数据中有 <a href="https://echarts.apache.org/zh/option.html#series-sunburst.data.link">link</a> 点击节点后会进行超链接跳转。</li>
     * </ul>
     */
    private Object nodeClick;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.sort">#series-sunburst.sort</a>
     * <br/>默认值: 'desc'
     * <br/>js类型: ["string","Function"]
     * <br/>描述:
     * <p>扇形块根据数据 <a href="https://echarts.apache.org/zh/option.html#series-sunburst.data.value"><code class="codespan">value</code></a> 的排序方式，如果未指定 <code class="codespan">value</code>，则其值为子元素 <code class="codespan">value</code> 之和。默认值 <code class="codespan">'desc'</code> 表示降序排序；还可以设置为 <code class="codespan">'asc'</code> 表示升序排序；<code class="codespan">null</code> 表示不排序，使用原始数据的顺序；或者用回调函数进行排列：</p>
    ...
    private Object sort;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.renderLabelForZeroData">#series-sunburst.renderLabelForZeroData</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.emphasis">#series-sunburst.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["any"]
     * <br/>描述:
     * <p>高亮状态配置。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.blur">#series-sunburst.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["any"]
     * <br/>描述:
     * <p>淡出状态配置。开启 <a href="https://echarts.apache.org/zh/option.html#series-sunburst.emphasis.focus">emphasis.focus</a> 后有效。</p>
     */
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.select">#series-sunburst.select</a>
     * <br/>默认值: 无
     * <br/>js类型: ["any"]
     * <br/>描述:
     * <p>选中状态配置。开启 <a href="https://echarts.apache.org/zh/option.html#series-sunburst.selectedMode">selectedMode</a> 后有效。</p>
     */
    private Select select;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.selectedMode">#series-sunburst.selectedMode</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean","string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.levels">#series-sunburst.levels</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animation">#series-sunburst.animation</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationThreshold">#series-sunburst.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationDuration">#series-sunburst.animationDuration</a>
     * <br/>默认值: 1000
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationEasing">#series-sunburst.animationEasing</a>
     * <br/>默认值: 'cubicOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationDelay">#series-sunburst.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationDurationUpdate">#series-sunburst.animationDurationUpdate</a>
     * <br/>默认值: 500
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationEasingUpdate">#series-sunburst.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.animationDelayUpdate">#series-sunburst.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
