...
import com.xmjz.echarts.nativebean.option.series.mapSeries.markArea.Data;
import com.xmjz.echarts.nativebean.option.series.mapSeries.markArea.Emphasis;
import com.xmjz.echarts.nativebean.option.series.mapSeries.markArea.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.mapSeries.markArea.Label;
import com.xmjz.echarts.nativebean.option.series.mapSeries.markArea.*;
...
public class MarkArea extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.silent">#series-map.markArea.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.itemStyle">#series-map.markArea.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>该标域的样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.emphasis">#series-map.markArea.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>高亮的标域样式</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.blur">#series-map.markArea.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
    ...
    private Data data;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animation">#series-map.markArea.animation</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationThreshold">#series-map.markArea.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationDuration">#series-map.markArea.animationDuration</a>
     * <br/>默认值: 1000
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationEasing">#series-map.markArea.animationEasing</a>
     * <br/>默认值: 'cubicOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationDelay">#series-map.markArea.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationDurationUpdate">#series-map.markArea.animationDurationUpdate</a>
     * <br/>默认值: 300
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationEasingUpdate">#series-map.markArea.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea.animationDelayUpdate">#series-map.markArea.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
