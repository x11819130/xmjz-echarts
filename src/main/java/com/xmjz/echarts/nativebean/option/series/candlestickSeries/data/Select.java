...
import com.xmjz.echarts.nativebean.option.series.candlestickSeries.data.select.ItemStyle;
...
public class Select extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-candlestick.data.select.disabled">#series-candlestick.data.select.disabled</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <blockquote>
