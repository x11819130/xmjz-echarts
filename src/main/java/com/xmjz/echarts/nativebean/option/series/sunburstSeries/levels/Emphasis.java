...
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.levels.emphasis.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.levels.emphasis.Label;
import com.xmjz.echarts.nativebean.option.series.sunburstSeries.levels.emphasis.LabelLine;
...
public class Emphasis extends BaseEcharts implements Serializable {
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.levels.emphasis.labelLine">#series-sunburst.levels.emphasis.labelLine</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标签的视觉引导线配置。</p>
