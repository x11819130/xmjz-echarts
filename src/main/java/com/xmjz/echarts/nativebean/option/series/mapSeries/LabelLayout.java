...
public class LabelLayout extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.hideOverlap">#series-map.labelLayout.hideOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否隐藏重叠的标签。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.moveOverlap">#series-map.labelLayout.moveOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.x">#series-map.labelLayout.x</a>
     * <br/>默认值: 无
    ...
    private Object x;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.y">#series-map.labelLayout.y</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","string"]
     * <br/>描述:
    ...
    private Object y;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.dx">#series-map.labelLayout.dx</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dx;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.dy">#series-map.labelLayout.dy</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dy;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.rotate">#series-map.labelLayout.rotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签旋转角度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.width">#series-map.labelLayout.width</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.height">#series-map.labelLayout.height</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签显示的高度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.align">#series-map.labelLayout.align</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.verticalAlign">#series-map.labelLayout.verticalAlign</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.fontSize">#series-map.labelLayout.fontSize</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.draggable">#series-map.labelLayout.draggable</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout.labelLinePoints">#series-map.labelLayout.labelLinePoints</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标签引导线三个点的位置。格式为：</p>
