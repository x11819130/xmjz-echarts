...
import com.xmjz.echarts.nativebean.option.series.boxplotSeries.select.ItemStyle;
...
public class Select extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.select.disabled">#series-boxplot.select.disabled</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <blockquote>
