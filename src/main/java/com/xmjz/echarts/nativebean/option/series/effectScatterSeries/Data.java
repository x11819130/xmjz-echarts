...
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.Blur;
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.Emphasis;
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.Label;
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.LabelLine;
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.Select;
import com.xmjz.echarts.nativebean.option.series.effectScatterSeries.data.Tooltip;
...
public class Data extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.symbol">#series-effectScatter.data.symbol</a>
     * <br/>默认值: 'circle'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>单个数据标记的图形。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.symbolSize">#series-effectScatter.data.symbolSize</a>
     * <br/>默认值: 4
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.symbolRotate">#series-effectScatter.data.symbolRotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.symbolKeepAspect">#series-effectScatter.data.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.symbolOffset">#series-effectScatter.data.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.labelLine">#series-effectScatter.data.labelLine</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标签的视觉引导线配置。</p>
    ...
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.select">#series-effectScatter.data.select</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>单个数据的选中图形和标签样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-effectScatter.data.tooltip">#series-effectScatter.data.tooltip</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
