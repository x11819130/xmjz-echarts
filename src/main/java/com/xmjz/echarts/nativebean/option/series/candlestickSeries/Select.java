...
import com.xmjz.echarts.nativebean.option.series.candlestickSeries.select.ItemStyle;
...
public class Select extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-candlestick.select.disabled">#series-candlestick.select.disabled</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <blockquote>
