package com.xmjz.echarts.nativebean.option.series.barSeries.select.labelLine;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle">#series-bar.select.labelLine.lineStyle</a>
 * <br/>默认值: 无
 * <br/>js类型: ["Object"]
 * <br/>描述:
 *
...
public class LineStyle extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.color">#series-bar.select.labelLine.lineStyle.color</a>
     * <br/>默认值: "#000"
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>线的颜色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.width">#series-bar.select.labelLine.lineStyle.width</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>线宽。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.type">#series-bar.select.labelLine.lineStyle.type</a>
     * <br/>默认值: 'solid'
    ...
    private Object type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.dashOffset">#series-bar.select.labelLine.lineStyle.dashOffset</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.cap">#series-bar.select.labelLine.lineStyle.cap</a>
     * <br/>默认值: 'butt'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String cap;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.join">#series-bar.select.labelLine.lineStyle.join</a>
     * <br/>默认值: 'bevel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String join;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.miterLimit">#series-bar.select.labelLine.lineStyle.miterLimit</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.shadowBlur">#series-bar.select.labelLine.lineStyle.shadowBlur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.shadowColor">#series-bar.select.labelLine.lineStyle.shadowColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.shadowOffsetX">#series-bar.select.labelLine.lineStyle.shadowOffsetX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影水平方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.shadowOffsetY">#series-bar.select.labelLine.lineStyle.shadowOffsetY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影垂直方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-bar.select.labelLine.lineStyle.opacity">#series-bar.select.labelLine.lineStyle.opacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
