...
import com.xmjz.echarts.nativebean.option.visualMap.continuousVisualMap.Controller;
import com.xmjz.echarts.nativebean.option.visualMap.continuousVisualMap.HandleStyle;
import com.xmjz.echarts.nativebean.option.visualMap.continuousVisualMap.IndicatorStyle;
import com.xmjz.echarts.nativebean.option.visualMap.continuousVisualMap.TextStyle;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous">#visualMap-continuous</a>
 * <br/>默认值: 无
 * <br/>js类型: ["object"]
 * <br/>描述:
 ...
 * <p><code class="codespan">visualMapContinuous</code>中，可以通过 <a href="https://echarts.apache.org/zh/option.html#visualMap.calculable">visualMap.calculable</a> 来显示或隐藏手柄（手柄能拖拽改变值域）。</p>
 *
 * @author auto
 */
@Getter
...
public class ContinuousVisualMap extends VisualMap implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.type">#visualMap-continuous.type</a>
     * <br/>默认值: continuous
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>类型为连续型。</p>
    ...
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.id">#visualMap-continuous.id</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String id;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.min">#visualMap-continuous.min</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer min;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.max">#visualMap-continuous.max</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer max;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.range">#visualMap-continuous.range</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     ...
     *         <span class="hljs-comment">// 两个手柄对应的数值是 4 和 15</span>
     *         <span class="hljs-attr">range</span>: [<span class="hljs-number">4</span>, <span class="hljs-number">15</span>],
     *         ...
     *     }
     * });
     * </code></pre>
     ...
     * </ul>
     * <pre><code class="lang-javascript hljs">例如：
     * chart.setOption({<span class="hljs-attr">visualMap</span>: {<span class="hljs-attr">min</span>: <span class="hljs-number">10</span>, <span class="hljs-attr">max</span>: <span class="hljs-number">300</span>}}); <span class="hljs-comment">// 不设置 range，则 range 默认为 [min, max]，即 [10, 300]。</span>
     *
     * chart.setOption({<span class="hljs-attr">visualMap</span>: {<span class="hljs-attr">min</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">max</span>: <span class="hljs-number">400</span>}}); <span class="hljs-comment">// 再次使用 setOption 改变 min、max。</span>
     * <span class="hljs-comment">// 此时 range 也自然会更新成改变过后的 [min, max]，即 [0, 400]。</span>
     * </code></pre>
     * <ul>
     * <li>如果 <code class="codespan">range</code> 被以具体值设置了（例如设置为 [10, 300]）</li>
     * </ul>
     * <pre><code class="lang-javascript hljs">例如：
     * chart.setOption({<span class="hljs-attr">visualMap</span>: {<span class="hljs-attr">min</span>: <span class="hljs-number">10</span>, <span class="hljs-attr">max</span>: <span class="hljs-number">300</span>, <span class="hljs-attr">range</span>: [<span class="hljs-number">20</span>, <span class="hljs-number">80</span>]}}); <span class="hljs-comment">// 设置了 range</span>
     *
     * chart.setOption({<span class="hljs-attr">visualMap</span>: {<span class="hljs-attr">min</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">max</span>: <span class="hljs-number">400</span>}}); <span class="hljs-comment">// 再次使用 setOption 改变 min、max。</span>
     * <span class="hljs-comment">// 此时 range 不会改变而仍维持本来的数值，仍为 [20, 80]。</span>
     *
     * chart.setOption({<span class="hljs-attr">visualMap</span>: {<span class="hljs-attr">range</span>: <span class="hljs-literal">null</span>}}); <span class="hljs-comment">// 再把 range 设为 null。</span>
     * <span class="hljs-comment">// 则 range 恢复为 [min, max]，即 [0, 400]，同时也恢复了自动随 min max 而改变的能力。</span>
     *
     * </code></pre>
    ...
    private List<?> range;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.calculable">#visualMap-continuous.calculable</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否显示拖拽用的手柄（手柄能拖拽调整选中范围）。</p>
     * <p>（注：为兼容 ECharts2，当 <a href="https://echarts.apache.org/zh/option.html#visualMap.type">visualMap.type</a> 未指定时，假如设置了 <code class="codespan">'calculable'</code>，则<code class="codespan">type</code>自动被设置为<code class="codespan">'continuous'</code>，无视 <a href="https://echarts.apache.org/zh/option.html#visualMap-piecewise.splitNumber">visualMap-piecewise.splitNumber</a> 等设置。所以，建议使用者不要不指定 <a href="https://echarts.apache.org/zh/option.html#visualMap.type">visualMap.type</a>，否则表意不清晰。）</p>
     */
    private Boolean calculable;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.realtime">#visualMap-continuous.realtime</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>拖拽时，是否实时更新。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.inverse">#visualMap-continuous.inverse</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     ...
     * <ul>
     * <li>当 <a href="https://echarts.apache.org/zh/option.html#visualMap.orient">visualMap.orient</a> 为<code class="codespan">'vertical'</code>时，数据上大下小。</li>
     * <li>当 <a href="https://echarts.apache.org/zh/option.html#visualMap.orient">visualMap.orient</a> 为<code class="codespan">'horizontal'</code>时，数据右大左小。</li>
     * </ul>
     * <p>当<code class="codespan">inverse</code>为<code class="codespan">true</code>时，相反。</p>
     */
    private Boolean inverse;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.precision">#visualMap-continuous.precision</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.itemWidth">#visualMap-continuous.itemWidth</a>
     * <br/>默认值: 20
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>图形的宽度，即长条的宽度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.itemHeight">#visualMap-continuous.itemHeight</a>
     * <br/>默认值: 140
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>图形的高度，即长条的高度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.align">#visualMap-continuous.align</a>
     * <br/>默认值: 'auto'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.text">#visualMap-continuous.text</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>两端的文本，如 <code class="codespan">['High', 'Low']</code>。<a href="https://echarts.apache.org/examples/zh/editor.html?c=doc-example/map-visualMap-continuous-text&amp;edit=1&amp;reset=1" target="_blank">参见例子</a>。</p>
    ...
    private List<?> text;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.textGap">#visualMap-continuous.textGap</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>两端文字主体之间的距离，单位为px。参见 <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.text">visualMap-continuous.text</a></p>
     */
    private Integer textGap;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.show">#visualMap-continuous.show</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否显示 visualMap-continuous 组件。如果设置为 <code class="codespan">false</code>，不会显示，但是数据映射的功能还存在。</p>
     */
    private Boolean show;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.dimension">#visualMap-continuous.dimension</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.seriesIndex">#visualMap-continuous.seriesIndex</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.hoverLink">#visualMap-continuous.hoverLink</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.inRange">#visualMap-continuous.inRange</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     ...
     *             }
     *         },
     *         <span class="hljs-comment">// 表示 visualMap-continuous 本身的视觉样式。</span>
     ...
     *     {
     *         ...,
     *         <span class="hljs-comment">// 表示 目标系列 的视觉样式 和 visualMap-continuous 共有的视觉样式。</span>
     *         <span class="hljs-attr">inRange</span>: {
     *             <span class="hljs-attr">color</span>: [<span class="hljs-string">'#121122'</span>, <span class="hljs-string">'rgba(3,4,5,0.4)'</span>, <span class="hljs-string">'red'</span>],
     *             <span class="hljs-attr">symbolSize</span>: [<span class="hljs-number">60</span>, <span class="hljs-number">200</span>]
     *         },
     *         <span class="hljs-comment">// 表示 visualMap-continuous 本身的视觉样式，会覆盖共有的视觉样式。比如，symbolSize 覆盖成为 [30, 100]，而 color 不变。</span>
     *         <span class="hljs-attr">controller</span>: {
     *             <span class="hljs-attr">inRange</span>: {
     *                 <span class="hljs-attr">symbolSize</span>: [<span class="hljs-number">30</span>, <span class="hljs-number">100</span>]
     *             }
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.outOfRange">#visualMap-continuous.outOfRange</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.zlevel">#visualMap-continuous.zlevel</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>所有图形的 zlevel 值。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.z">#visualMap-continuous.z</a>
     * <br/>默认值: 4
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer z;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.left">#visualMap-continuous.left</a>
     * <br/>默认值: 无
    ...
    private Object left;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.top">#visualMap-continuous.top</a>
     * <br/>默认值: auto
     * <br/>js类型: ["string","number"]
     * <br/>描述:
    ...
    private Object top;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.right">#visualMap-continuous.right</a>
     * <br/>默认值: auto
     * <br/>js类型: ["string","number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.bottom">#visualMap-continuous.bottom</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string","number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.orient">#visualMap-continuous.orient</a>
     * <br/>默认值: 'vertical'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.padding">#visualMap-continuous.padding</a>
     * <br/>默认值: 5
     * <br/>js类型: ["number","Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.backgroundColor">#visualMap-continuous.backgroundColor</a>
     * <br/>默认值: 'rgba(0,0,0,0)'
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>背景色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.borderColor">#visualMap-continuous.borderColor</a>
     * <br/>默认值: '#ccc'
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>边框颜色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.borderWidth">#visualMap-continuous.borderWidth</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>边框线宽，单位px。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.color">#visualMap-continuous.color</a>
     * <br/>默认值: ['#bf444c', '#d88273', '#f6efa6']
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>这个配置项，是为了兼容 ECharts2 而存在，ECharts3 中已经不推荐使用。它的功能已经移到了 <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.inRange">visualMap-continuous.inRange</a> 和 <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.outOfRange">visualMap-continuous.outOfRange</a> 中。</p>
     * <p>如果要使用，则须注意，<code class="codespan">color</code>属性中的顺序是由数值 <code class="codespan">大</code> 到 <code class="codespan">小</code>，但是 <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.inRange">visualMap-continuous.inRange</a> 或 <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.outOfRange">visualMap-continuous.outOfRange</a> 中 <code class="codespan">color</code> 的顺序，总是由数值 <code class="codespan">小</code> 到 <code class="codespan">大</code>。二者不一致。</p>
     */
    private List<?> color;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.textStyle">#visualMap-continuous.textStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     */
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.formatter">#visualMap-continuous.formatter</a>
     * <br/>默认值: 无
     ...
     * </ul>
     * <pre><code class="lang-javascript hljs">formatter: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
     *     <span class="hljs-keyword">return</span> <span class="hljs-string">'aaaa'</span> + value; <span class="hljs-comment">// 范围标签显示内容。</span>
     * }
     * </code></pre>
     */
    private Object formatter;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.handleIcon">#visualMap-continuous.handleIcon</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
     ...
     *
     * <p>两端手柄的形状。默认为</p>
     * <pre><code class="lang-ts hljs typescript"><span class="hljs-string">'M-11.39,9.77h0a3.5,3.5,0,0,1-3.5,3.5h-22a3.5,3.5,0,0,1-3.5-3.5h0a3.5,3.5,0,0,1,3.5-3.5h22A3.5,3.5,0,0,1-11.39,9.77Z'</span>
     * </code></pre>
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
     * <p>URL 为图片链接例如：</p>
     * <pre><code class="hljs javascript"><span class="hljs-string">'image://http://xxx.xxx.xxx/a/b.png'</span>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.handleSize">#visualMap-continuous.handleSize</a>
     * <br/>默认值: '120%'
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.handleStyle">#visualMap-continuous.handleStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.indicatorIcon">#visualMap-continuous.indicatorIcon</a>
     * <br/>默认值: 'circle'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>指示器的形状，默认为圆形。指示器在鼠标移到组件上，或者在移到系列图形上联动高亮的时候出现。</p>
     * <blockquote>
     * <p>从 <code class="codespan">v5.0.0</code> 开始支持</p>
     * </blockquote>
     */
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.indicatorSize">#visualMap-continuous.indicatorSize</a>
     * <br/>默认值: '50%'
     * <br/>js类型: ["number","string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#visualMap-continuous.indicatorStyle">#visualMap-continuous.indicatorStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>指示器样式。</p>
