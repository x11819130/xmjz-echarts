...
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.Blur;
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.Emphasis;
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.Label;
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.LabelLine;
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.Select;
import com.xmjz.echarts.nativebean.option.series.pieSeries.data.Tooltip;
...
public class Data extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pie.data.name">#series-pie.data.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据项名称。</p>
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pie.data.value">#series-pie.data.value</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>数据值。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pie.data.groupId">#series-pie.data.groupId</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pie.data.selected">#series-pie.data.selected</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>该数据项是否被选中。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pie.data.emphasis">#series-pie.data.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     */
