...
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.Blur;
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.Emphasis;
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.Label;
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.LabelLine;
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.Select;
import com.xmjz.echarts.nativebean.option.series.scatterSeries.data.Tooltip;
...
public class Data extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.name">#series-scatter.data.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据项名称。</p>
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.value">#series-scatter.data.value</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>数据项值。</p>
    ...
    private List<?> value;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.groupId">#series-scatter.data.groupId</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.symbol">#series-scatter.data.symbol</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>单个数据标记的图形。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.symbolSize">#series-scatter.data.symbolSize</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.symbolRotate">#series-scatter.data.symbolRotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.symbolKeepAspect">#series-scatter.data.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.symbolOffset">#series-scatter.data.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.itemStyle">#series-scatter.data.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>单个数据点（气泡）的样式设置。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.blur">#series-scatter.data.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
    ...
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.select">#series-scatter.data.select</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-scatter.data.tooltip">#series-scatter.data.tooltip</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
