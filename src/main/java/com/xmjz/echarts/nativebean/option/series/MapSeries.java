...
import com.xmjz.echarts.nativebean.option.series.mapSeries.*;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map">#series-map</a>
 * <br/>默认值: 无
 * <br/>js类型: ["object"]
 * <br/>描述:
 * <p><strong>地图。</strong></p>
 * <p>地图主要用于地理区域数据的可视化，配合 <a href="https://echarts.apache.org/zh/option.html#visualMap">visualMap</a> 组件用于展示不同区域的人口分布密度等数据。</p>
 * <p>多个<a href="https://echarts.apache.org/zh/option.html#series-map.map">地图类型</a>相同的系列会在同一地图上显示，这时候使用第一个系列的配置项作为地图绘制的配置。</p>
 * <p><strong>Tip: </strong>在 ECharts 3 中不再建议在地图类型的图表使用 <code class="codespan">markLine</code> 和 <code class="codespan">markPoint</code>。如果要实现点数据或者线数据的可视化，可以使用在<a href="https://echarts.apache.org/zh/option.html#geo">地理坐标系组件</a>上的<a href="https://echarts.apache.org/zh/option.html#series-scatter">散点图</a>和<a href="https://echarts.apache.org/zh/option.html#series-lines">线图</a>。</p>
 *
 * @author auto
 */
@Getter
...
public class MapSeries extends Series implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.type">#series-map.type</a>
     * <br/>默认值: 'map'
     * <br/>js类型: ["string"]
     * <br/>描述:
     */
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.id">#series-map.id</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String id;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.name">#series-map.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.colorBy">#series-map.colorBy</a>
     * <br/>默认值: 'series'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.map">#series-map.map</a>
     * <br/>默认值: ''
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String map;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.roam">#series-map.roam</a>
     * <br/>默认值: 无
    ...
    private Object roam;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.projection">#series-map.projection</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.center">#series-map.center</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    private List<?> center;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.aspectScale">#series-map.aspectScale</a>
     * <br/>默认值: 0.75
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.boundingCoords">#series-map.boundingCoords</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.zoom">#series-map.zoom</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>当前视角的缩放比例。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.scaleLimit">#series-map.scaleLimit</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.nameMap">#series-map.nameMap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>自定义地区的名称映射，如：</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.nameProperty">#series-map.nameProperty</a>
     * <br/>默认值: 'name'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.selectedMode">#series-map.selectedMode</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean","string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.label">#series-map.label</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.itemStyle">#series-map.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>地图区域的多边形 图形样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.emphasis">#series-map.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>高亮状态下的多边形和标签样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.zlevel">#series-map.zlevel</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>所有图形的 zlevel 值。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.z">#series-map.z</a>
     * <br/>默认值: 2
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer z;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.left">#series-map.left</a>
     * <br/>默认值: 'auto'
    ...
    private Object left;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.top">#series-map.top</a>
     * <br/>默认值: 'auto'
     * <br/>js类型: ["string","number"]
     * <br/>描述:
     * <p>组件离容器上侧的距离。</p>
    ...
    private Object top;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.right">#series-map.right</a>
     * <br/>默认值: 'auto'
     * <br/>js类型: ["string","number"]
     * <br/>描述:
     * <p>组件离容器右侧的距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.bottom">#series-map.bottom</a>
     * <br/>默认值: 'auto'
     * <br/>js类型: ["string","number"]
     * <br/>描述:
     * <p>组件离容器下侧的距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.layoutCenter">#series-map.layoutCenter</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.layoutSize">#series-map.layoutSize</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.geoIndex">#series-map.geoIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>默认情况下，map series 会自己生成内部专用的 <code class="codespan">geo</code> 组件。但是也可以用这个 <code class="codespan">geoIndex</code> 指定一个 <a href="https://echarts.apache.org/zh/option.html#geo">geo</a> 组件。这样的话，map 和 其他 series（例如散点图）就可以共享一个 <a href="https://echarts.apache.org/zh/option.html#geo">geo</a> 组件了。并且，<a href="https://echarts.apache.org/zh/option.html#geo">geo</a> 组件的颜色也可以被这个 map series 控制，从而用 <a href="https://echarts.apache.org/zh/option.html#visualMap">visualMap</a> 来更改。</p>
     * <p>当设定了 <code class="codespan">geoIndex</code> 后，<a href="https://echarts.apache.org/zh/option.html#series-map.map">series-map.map</a> 属性，以及 <a href="https://echarts.apache.org/zh/option.html#series-map.itemStyle">series-map.itemStyle</a> 等样式配置不再起作用，而是采用 <a href="https://echarts.apache.org/zh/option.html#geo">geo</a> 中的相应属性。</p>
     */
    private Integer geoIndex;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.mapValueCalculation">#series-map.mapValueCalculation</a>
     * <br/>默认值: 'sum'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>多个拥有相同<a href="https://echarts.apache.org/zh/option.html#series-map.map">地图类型</a>的系列会使用同一个地图展现，如果多个系列都在同一个区域有值，ECharts 会对这些值统计得到一个数据。这个配置项就是用于配置统计的方式，目前有：</p>
     * <ul>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.showLegendSymbol">#series-map.showLegendSymbol</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>在图例相应区域显示图例的颜色标识（系列标识的小圆点），存在 <a href="https://echarts.apache.org/zh/option.html#legend">legend</a> 组件时生效。</p>
     */
    private Boolean showLegendSymbol;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.seriesLayoutBy">#series-map.seriesLayoutBy</a>
     * <br/>默认值: 'column'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.datasetIndex">#series-map.datasetIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.dataGroupId">#series-map.dataGroupId</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.labelLayout">#series-map.labelLayout</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markPoint">#series-map.markPoint</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>图表标注。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markLine">#series-map.markLine</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>图表标线。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.markArea">#series-map.markArea</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.silent">#series-map.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.universalTransition">#series-map.universalTransition</a>
     * <br/>默认值: 无
     * <br/>js类型: ["object"]
     * <br/>描述:
     * <p>全局过渡动画相关的配置。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-map.tooltip">#series-map.tooltip</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
