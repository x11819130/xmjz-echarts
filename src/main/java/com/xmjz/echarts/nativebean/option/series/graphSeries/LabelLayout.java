...
public class LabelLayout extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.hideOverlap">#series-graph.labelLayout.hideOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否隐藏重叠的标签。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.moveOverlap">#series-graph.labelLayout.moveOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.x">#series-graph.labelLayout.x</a>
     * <br/>默认值: 无
    ...
    private Object x;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.y">#series-graph.labelLayout.y</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","string"]
     * <br/>描述:
    ...
    private Object y;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.dx">#series-graph.labelLayout.dx</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dx;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.dy">#series-graph.labelLayout.dy</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dy;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.rotate">#series-graph.labelLayout.rotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签旋转角度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.width">#series-graph.labelLayout.width</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.height">#series-graph.labelLayout.height</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签显示的高度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.align">#series-graph.labelLayout.align</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.verticalAlign">#series-graph.labelLayout.verticalAlign</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.fontSize">#series-graph.labelLayout.fontSize</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.draggable">#series-graph.labelLayout.draggable</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.labelLayout.labelLinePoints">#series-graph.labelLayout.labelLinePoints</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标签引导线三个点的位置。格式为：</p>
