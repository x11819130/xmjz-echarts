...
import com.xmjz.echarts.nativebean.option.series.heatmapSeries.*;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap">#series-heatmap</a>
 * <br/>默认值: 无
 * <br/>js类型: ["object"]
 * <br/>描述:
 * <p><strong>热力图</strong></p>
 * <p>热力图主要通过颜色去表现数值的大小，必须要配合 <a href="https://echarts.apache.org/zh/option.html#visualMap">visualMap</a> 组件使用。</p>
 * <p>可以应用在<a href="https://echarts.apache.org/zh/option.html#grid">直角坐标系</a>以及<a href="https://echarts.apache.org/zh/option.html#geo">地理坐标系</a>上，这两个坐标系上的表现形式相差很大，直角坐标系上必须要使用两个类目轴。</p>
 * <p>下面是在直角坐标系上应用的例子：</p>
 * <p><strong>直角坐标系：</strong></p>
 * <iframe data-src="https://echarts.apache.org/examples/zh/view.html?c=heatmap-cartesian&amp;edit=1&amp;reset=1" width="600" height="400" data-ll-timeout="26"></iframe>
 *
 * @author auto
 */
@Getter
...
public class HeatmapSeries extends Series implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.type">#series-heatmap.type</a>
     * <br/>默认值: 'heatmap'
     * <br/>js类型: ["string"]
     * <br/>描述:
     */
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.id">#series-heatmap.id</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String id;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.name">#series-heatmap.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">#series-heatmap.coordinateSystem</a>
     * <br/>默认值: 'cartesian2d'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>该系列使用的坐标系，可选：</p>
     ...
     * <p>  使用二维的直角坐标系（也称笛卡尔坐标系），通过 <a href="https://echarts.apache.org/zh/option.html#series-heatmap.xAxisIndex">xAxisIndex</a>, <a href="https://echarts.apache.org/zh/option.html#series-heatmap.yAxisIndex">yAxisIndex</a>指定相应的坐标轴组件。</p>
     * </li>
     * </ul>
     * <ul>
     * <li><p><code class="codespan">'geo'</code></p>
     * <p>  使用地理坐标系，通过 <a href="https://echarts.apache.org/zh/option.html#series-heatmap.geoIndex">geoIndex</a> 指定相应的地理坐标系组件。</p>
     * </li>
     * </ul>
     */
    private String coordinateSystem;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.xAxisIndex">#series-heatmap.xAxisIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.yAxisIndex">#series-heatmap.yAxisIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.geoIndex">#series-heatmap.geoIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.calendarIndex">#series-heatmap.calendarIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.pointSize">#series-heatmap.pointSize</a>
     * <br/>默认值: 20
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>每个点的大小，在地理坐标系(<a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">coordinateSystem</a>: 'geo')上有效。</p>
     */
    private Integer pointSize;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.blurSize">#series-heatmap.blurSize</a>
     * <br/>默认值: 20
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>每个点模糊的大小，在地理坐标系(<a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">coordinateSystem</a>: 'geo')上有效。</p>
     */
    private Integer blurSize;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.minOpacity">#series-heatmap.minOpacity</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>最小的透明度，在地理坐标系(<a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">coordinateSystem</a>: 'geo')上有效。</p>
     */
    private Integer minOpacity;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.maxOpacity">#series-heatmap.maxOpacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>最大的透明度，在地理坐标系(<a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">coordinateSystem</a>: 'geo')上有效。</p>
     */
    private Integer maxOpacity;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.progressive">#series-heatmap.progressive</a>
     * <br/>默认值: 400
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.progressiveThreshold">#series-heatmap.progressiveThreshold</a>
     * <br/>默认值: 3000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.label">#series-heatmap.label</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>在直角坐标系(<a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">coordinateSystem</a>: 'cartesian2d')上有效。</p>
     */
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.labelLayout">#series-heatmap.labelLayout</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.itemStyle">#series-heatmap.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>样式设置，在直角坐标系(<a href="https://echarts.apache.org/zh/option.html#series-heatmap.coordinateSystem">coordinateSystem</a>: 'cartesian2d')上有效。</p>
     */
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.universalTransition">#series-heatmap.universalTransition</a>
     * <br/>默认值: 无
     * <br/>js类型: ["object"]
     * <br/>描述:
     * <p>全局过渡动画相关的配置。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.blur">#series-heatmap.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
     * <p>从 <code class="codespan">v5.0.0</code> 开始支持</p>
     * </blockquote>
     * <p>淡出状态的图形样式。开启 <a href="https://echarts.apache.org/zh/option.html#series-heatmap.emphasis.focus">emphasis.focus</a> 后有效。</p>
     */
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.select">#series-heatmap.select</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
     * <p>从 <code class="codespan">v5.0.0</code> 开始支持</p>
     * </blockquote>
     * <p>选中状态的图形样式。开启 <a href="https://echarts.apache.org/zh/option.html#series-heatmap.selectedMode">selectedMode</a> 后有效。</p>
     */
    private Select select;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.selectedMode">#series-heatmap.selectedMode</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.encode">#series-heatmap.encode</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.seriesLayoutBy">#series-heatmap.seriesLayoutBy</a>
     * <br/>默认值: 'column'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.datasetIndex">#series-heatmap.datasetIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.dataGroupId">#series-heatmap.dataGroupId</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.data">#series-heatmap.data</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.markPoint">#series-heatmap.markPoint</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>图表标注。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.markArea">#series-heatmap.markArea</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.zlevel">#series-heatmap.zlevel</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.z">#series-heatmap.z</a>
     * <br/>默认值: 2
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer z;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.silent">#series-heatmap.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-heatmap.tooltip">#series-heatmap.tooltip</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
