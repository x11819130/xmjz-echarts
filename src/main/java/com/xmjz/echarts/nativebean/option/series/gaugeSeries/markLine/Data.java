...
import com.xmjz.echarts.nativebean.option.series.gaugeSeries.markLine.data.Blur;
import com.xmjz.echarts.nativebean.option.series.gaugeSeries.markLine.data.Emphasis;
import com.xmjz.echarts.nativebean.option.series.gaugeSeries.markLine.data.Label;
import com.xmjz.echarts.nativebean.option.series.gaugeSeries.markLine.data.LineStyle;
...
public class Data extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.name">#series-gauge.markLine.data.0.name</a>
     * <br/>默认值: '起点'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>标注名称，将会作为文字显示。</p>
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.x">#series-gauge.markLine.data.0.x</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer x;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.y">#series-gauge.markLine.data.0.y</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer y;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.xAxis">#series-gauge.markLine.data.0.xAxis</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.yAxis">#series-gauge.markLine.data.0.yAxis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.value">#series-gauge.markLine.data.0.value</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标注值，可以不设。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.symbol">#series-gauge.markLine.data.0.symbol</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>起点标记的图形。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.symbolSize">#series-gauge.markLine.data.0.symbolSize</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.symbolRotate">#series-gauge.markLine.data.0.symbolRotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.symbolKeepAspect">#series-gauge.markLine.data.0.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.symbolOffset">#series-gauge.markLine.data.0.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.lineStyle">#series-gauge.markLine.data.0.lineStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.emphasis">#series-gauge.markLine.data.0.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     */
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.markLine.data.0.blur">#series-gauge.markLine.data.0.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
