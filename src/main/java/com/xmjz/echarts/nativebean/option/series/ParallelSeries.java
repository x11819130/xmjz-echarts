...
import com.xmjz.echarts.nativebean.option.series.parallelSeries.Data;
import com.xmjz.echarts.nativebean.option.series.parallelSeries.Emphasis;
import com.xmjz.echarts.nativebean.option.series.parallelSeries.LineStyle;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel">#series-parallel</a>
 * <br/>默认值: 无
 * <br/>js类型: ["object"]
 * <br/>描述:
 * <p>平行坐标系的系列。</p>
 ...
 * };
 * </code></pre>
 * <p>需要涉及到三个组件：<a href="https://echarts.apache.org/zh/option.html#parallel">parallel</a>、<a href="https://echarts.apache.org/zh/option.html#parallelAxis">parallelAxis</a>、<a href="https://echarts.apache.org/zh/option.html#series-parallel">series-parallel</a></p>
 * <ul>
 * <li><p><a href="https://echarts.apache.org/zh/option.html#parallel">parallel</a></p>
 ...
 * <p>  位置设置，也是放在这里进行。</p>
 * </li>
 * <li><p><a href="https://echarts.apache.org/zh/option.html#parallelAxis">parallelAxis</a></p>
 * <p>  这个是『坐标系』中的坐标轴的配置。自然，需要有多个坐标轴。</p>
 * <p>  其中有 <a href="https://echarts.apache.org/zh/option.html#parallelAxis.parallelIndex">parallelAxis.parallelIndex</a> 属性，指定这个『坐标轴』在哪个『坐标系』中。默认使用第一个『坐标系』。</p>
 * </li>
 * <li><p><a href="https://echarts.apache.org/zh/option.html#series-parallel">series-parallel</a></p>
 * <p>  这个是『系列』的定义。系列被画到『坐标系』上。</p>
 * <p>  其中有 <a href="https://echarts.apache.org/zh/option.html#series-parallel.parallelIndex">series-parallel.parallelIndex</a> 属性，指定使用哪个『坐标系』。默认使用第一个『坐标系』。</p>
 * </li>
 * </ul>
 * <p><strong>配置注意和最佳实践</strong></p>
 * <p>配置多个 <a href="https://echarts.apache.org/zh/option.html#parallelAxis">parallelAxis</a> 时，有些值一样的属性，如果书写多遍则比较繁琐，那么可以放置在 <a href="https://echarts.apache.org/zh/option.html#parallel.parallelAxisDefault">parallel.parallelAxisDefault</a> 里。在坐标轴初始化前，<a href="https://echarts.apache.org/zh/option.html#parallel.parallelAxisDefault">parallel.parallelAxisDefault</a> 里的配置项，会分别融合进 <a href="https://echarts.apache.org/zh/option.html#parallelAxis">parallelAxis</a>，形成最终的坐标轴的配置。</p>
 * <p><strong>如果数据量很大并且发生卡顿</strong></p>
 * <p>建议把 <a href="https://echarts.apache.org/zh/option.html#series-parallel.lineStyle.width">series-parallel.lineStyle.width</a> 设为 <code class="codespan">0.5</code>（或更小），
 * 可能显著改善性能。</p>
 * <p><strong>高维数据的显示</strong></p>
 * <p>维度比较多时，比如有 50+ 的维度，那么就会有 50+ 个轴。那么可能会页面显示不下。</p>
 * <p>可以通过 <a href="https://echarts.apache.org/zh/option.html#parallel.axisExpandable">parallel.axisExpandable</a> 来改善显示效果。</p>
 *
 * @author auto
 */
@Getter
...
public class ParallelSeries extends Series implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.type">#series-parallel.type</a>
     * <br/>默认值: 'parallel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     */
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.id">#series-parallel.id</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String id;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.coordinateSystem">#series-parallel.coordinateSystem</a>
     * <br/>默认值: 'parallel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>该系列使用的坐标系，可选：</p>
     ...
     * <p>  使用平行坐标系，通过 <a href="https://echarts.apache.org/zh/option.html#series-parallel.parallelIndex">parallelIndex</a> 指定相应的平行坐标系组件。</p>
     * </li>
     * </ul>
     */
    private String coordinateSystem;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.parallelIndex">#series-parallel.parallelIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>使用的<a href="https://echarts.apache.org/zh/option.html#parallel">平行坐标系</a>的 index，在单个图表实例中存在多个平行坐标系的时候有用。</p>
     */
    private Integer parallelIndex;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.name">#series-parallel.name</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.colorBy">#series-parallel.colorBy</a>
     * <br/>默认值: 'series'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.lineStyle">#series-parallel.lineStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>线条样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.emphasis">#series-parallel.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     */
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.inactiveOpacity">#series-parallel.inactiveOpacity</a>
     * <br/>默认值: 0.05
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.activeOpacity">#series-parallel.activeOpacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.realtime">#series-parallel.realtime</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否实时刷新。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.smooth">#series-parallel.smooth</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.progressive">#series-parallel.progressive</a>
     * <br/>默认值: 500
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.progressiveThreshold">#series-parallel.progressiveThreshold</a>
     * <br/>默认值: 3000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.progressiveChunkMode">#series-parallel.progressiveChunkMode</a>
     * <br/>默认值: 'sequential'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>分片的方式。可选值：</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.zlevel">#series-parallel.zlevel</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.z">#series-parallel.z</a>
     * <br/>默认值: 2
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer z;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.silent">#series-parallel.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animation">#series-parallel.animation</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationThreshold">#series-parallel.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationDuration">#series-parallel.animationDuration</a>
     * <br/>默认值: 1000
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationEasing">#series-parallel.animationEasing</a>
     * <br/>默认值: linear
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationDelay">#series-parallel.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationDurationUpdate">#series-parallel.animationDurationUpdate</a>
     * <br/>默认值: 300
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationEasingUpdate">#series-parallel.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-parallel.animationDelayUpdate">#series-parallel.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
