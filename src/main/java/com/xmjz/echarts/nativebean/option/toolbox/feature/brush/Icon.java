...
public class Icon extends BaseEcharts implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.brush.icon.rect">#toolbox.feature.brush.icon.rect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String rect;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.brush.icon.polygon">#toolbox.feature.brush.icon.polygon</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.brush.icon.lineX">#toolbox.feature.brush.icon.lineX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.brush.icon.lineY">#toolbox.feature.brush.icon.lineY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.brush.icon.keep">#toolbox.feature.brush.icon.keep</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
    ...
    private String keep;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.brush.icon.clear">#toolbox.feature.brush.icon.clear</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
