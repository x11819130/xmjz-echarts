...
public class Icon extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.magicType.icon.line">#toolbox.feature.magicType.icon.line</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String line;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.magicType.icon.bar">#toolbox.feature.magicType.icon.bar</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
    ...
    private String bar;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#toolbox.feature.magicType.icon.stack">#toolbox.feature.magicType.icon.stack</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>可以通过 <code class="codespan">'image://url'</code> 设置为图片，其中 URL 为图片的链接，或者 <code class="codespan">dataURI</code>。</p>
