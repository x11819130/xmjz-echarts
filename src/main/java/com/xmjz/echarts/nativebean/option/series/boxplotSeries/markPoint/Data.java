...
import com.xmjz.echarts.nativebean.option.series.boxplotSeries.markPoint.data.Emphasis;
import com.xmjz.echarts.nativebean.option.series.boxplotSeries.markPoint.data.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.boxplotSeries.markPoint.data.Label;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data">#series-boxplot.markPoint.data</a>
 * <br/>默认值: 无
 * <br/>js类型: ["Array"]
 * <br/>描述:
 * <p>标注的数据数组。每个数组项是一个对象，有下面几种方式指定标注的位置。</p>
 * <ol>
 * <li>通过 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.x">x</a>, <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.y">y</a> 属性指定相对容器的屏幕坐标，单位像素，支持百分比。</li>
 * </ol>
 * <ol start="2">
 * <li><p>用 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.coord">coord</a> 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 <code class="codespan">'min'</code>, <code class="codespan">'max'</code>, <code class="codespan">'average'</code>。</p>
 * </li>
 * <li><p>直接用 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.type">type</a> 属性标注系列中的最大值，最小值。这时候可以使用 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.valueIndex">valueIndex</a> 或者 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.valueDim">valueDim</a> 指定是在哪个维度上的最大值、最小值、平均值。</p>
 * </li>
 * </ol>
...
public class Data extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.name">#series-boxplot.markPoint.data.name</a>
     * <br/>默认值: ''
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>标注名称。</p>
    ...
    private String name;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.type">#series-boxplot.markPoint.data.type</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    private String type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.valueIndex">#series-boxplot.markPoint.data.valueIndex</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>在使用 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.type">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class="codespan">0</code>（xAxis, radiusAxis），<code class="codespan">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>
     */
    private Integer valueIndex;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.valueDim">#series-boxplot.markPoint.data.valueDim</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>在使用 <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.type">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class="codespan">x</code>、<code class="codespan">angle</code>等、candlestick 图时可以是<code class="codespan">open</code>、<code class="codespan">close</code>等维度名称。</p>
     */
    private String valueDim;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.coord">#series-boxplot.markPoint.data.coord</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    private List<?> coord;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.x">#series-boxplot.markPoint.data.x</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer x;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.y">#series-boxplot.markPoint.data.y</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer y;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.value">#series-boxplot.markPoint.data.value</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标注值，可以不设。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.symbol">#series-boxplot.markPoint.data.symbol</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>标记的图形。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.symbolSize">#series-boxplot.markPoint.data.symbolSize</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.symbolRotate">#series-boxplot.markPoint.data.symbolRotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.symbolKeepAspect">#series-boxplot.markPoint.data.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.symbolOffset">#series-boxplot.markPoint.data.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.itemStyle">#series-boxplot.markPoint.data.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>该标注的样式。</p>
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-boxplot.markPoint.data.emphasis">#series-boxplot.markPoint.data.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     */
