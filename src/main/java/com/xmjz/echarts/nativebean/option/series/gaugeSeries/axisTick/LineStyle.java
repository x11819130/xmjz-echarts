package com.xmjz.echarts.nativebean.option.series.gaugeSeries.axisTick;
...
public class LineStyle extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.color">#series-gauge.axisTick.lineStyle.color</a>
     * <br/>默认值: #63677A
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>线的颜色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.width">#series-gauge.axisTick.lineStyle.width</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>线宽。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.type">#series-gauge.axisTick.lineStyle.type</a>
     * <br/>默认值: 'solid'
    ...
    private Object type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.dashOffset">#series-gauge.axisTick.lineStyle.dashOffset</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.cap">#series-gauge.axisTick.lineStyle.cap</a>
     * <br/>默认值: 'butt'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String cap;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.join">#series-gauge.axisTick.lineStyle.join</a>
     * <br/>默认值: 'bevel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String join;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.miterLimit">#series-gauge.axisTick.lineStyle.miterLimit</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.shadowBlur">#series-gauge.axisTick.lineStyle.shadowBlur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.shadowColor">#series-gauge.axisTick.lineStyle.shadowColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.shadowOffsetX">#series-gauge.axisTick.lineStyle.shadowOffsetX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影水平方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.shadowOffsetY">#series-gauge.axisTick.lineStyle.shadowOffsetY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影垂直方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.axisTick.lineStyle.opacity">#series-gauge.axisTick.lineStyle.opacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
