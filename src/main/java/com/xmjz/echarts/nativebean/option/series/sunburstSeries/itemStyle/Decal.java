package com.xmjz.echarts.nativebean.option.series.sunburstSeries.itemStyle;
...
public class Decal extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.symbol">#series-sunburst.itemStyle.decal.symbol</a>
     * <br/>默认值: 'rect'
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.symbolSize">#series-sunburst.itemStyle.decal.symbolSize</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.symbolKeepAspect">#series-sunburst.itemStyle.decal.symbolKeepAspect</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否保持图案的长宽比。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.color">#series-sunburst.itemStyle.decal.color</a>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.backgroundColor">#series-sunburst.itemStyle.decal.backgroundColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.dashArrayX">#series-sunburst.itemStyle.decal.dashArrayX</a>
     * <br/>默认值: 5
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.dashArrayY">#series-sunburst.itemStyle.decal.dashArrayY</a>
     * <br/>默认值: 5
     * <br/>js类型: ["number","Array"]
     * <br/>描述:
     * <p>贴花图案的基本模式是在横向和纵向上分别以<code class="codespan">图案 - 空白 - 图案 - 空白 - 图案 - 空白</code>的形式无限循环。通过设置每个图案和空白的长度，可以实现复杂的图案效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.rotation">#series-sunburst.itemStyle.decal.rotation</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.maxTileWidth">#series-sunburst.itemStyle.decal.maxTileWidth</a>
     * <br/>默认值: 512
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sunburst.itemStyle.decal.maxTileHeight">#series-sunburst.itemStyle.decal.maxTileHeight</a>
     * <br/>默认值: 512
     * <br/>js类型: ["number"]
     * <br/>描述:
