...
import com.xmjz.echarts.nativebean.option.series.graphSeries.markPoint.Blur;
import com.xmjz.echarts.nativebean.option.series.graphSeries.markPoint.Data;
import com.xmjz.echarts.nativebean.option.series.graphSeries.markPoint.Emphasis;
import com.xmjz.echarts.nativebean.option.series.graphSeries.markPoint.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.graphSeries.markPoint.Label;
...
public class MarkPoint extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.symbol">#series-graph.markPoint.symbol</a>
     * <br/>默认值: 'pin'
     ...
     * </code></pre>
     * <p>其中第一个参数 <code class="codespan">value</code> 为 <a href="https://echarts.apache.org/zh/option.html#series-graph.data">data</a> 中的数据值。第二个参数<code class="codespan">params</code> 是其它的数据项参数。</p>
     */
    private Object symbol;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.symbolSize">#series-graph.markPoint.symbolSize</a>
     * <br/>默认值: 50
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.symbolRotate">#series-graph.markPoint.symbolRotate</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.symbolKeepAspect">#series-graph.markPoint.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.symbolOffset">#series-graph.markPoint.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.silent">#series-graph.markPoint.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.itemStyle">#series-graph.markPoint.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标注的样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.emphasis">#series-graph.markPoint.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标注的高亮样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.blur">#series-graph.markPoint.blur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <blockquote>
    ...
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data">#series-graph.markPoint.data</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标注的数据数组。每个数组项是一个对象，有下面几种方式指定标注的位置。</p>
     * <ol>
     * <li>通过 <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data.x">x</a>, <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data.y">y</a> 属性指定相对容器的屏幕坐标，单位像素，支持百分比。</li>
     * </ol>
     * <ol start="2">
     * <li><p>用 <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data.coord">coord</a> 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 <code class="codespan">'min'</code>, <code class="codespan">'max'</code>, <code class="codespan">'average'</code>。</p>
     * </li>
     * <li><p>直接用 <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data.type">type</a> 属性标注系列中的最大值，最小值。这时候可以使用 <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data.valueIndex">valueIndex</a> 或者 <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.data.valueDim">valueDim</a> 指定是在哪个维度上的最大值、最小值、平均值。</p>
     * </li>
     * </ol>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animation">#series-graph.markPoint.animation</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationThreshold">#series-graph.markPoint.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationDuration">#series-graph.markPoint.animationDuration</a>
     * <br/>默认值: 1000
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationEasing">#series-graph.markPoint.animationEasing</a>
     * <br/>默认值: 'cubicOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationDelay">#series-graph.markPoint.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationDurationUpdate">#series-graph.markPoint.animationDurationUpdate</a>
     * <br/>默认值: 300
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationEasingUpdate">#series-graph.markPoint.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-graph.markPoint.animationDelayUpdate">#series-graph.markPoint.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
