package com.xmjz.echarts.nativebean.option.series.gaugeSeries.splitLine;
...
public class LineStyle extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.color">#series-gauge.splitLine.lineStyle.color</a>
     * <br/>默认值: #63677A
     * <br/>js类型: ["Color"]
     * <br/>描述:
     * <p>线的颜色。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.width">#series-gauge.splitLine.lineStyle.width</a>
     * <br/>默认值: 3
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>线宽。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.type">#series-gauge.splitLine.lineStyle.type</a>
     * <br/>默认值: 'solid'
    ...
    private Object type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.dashOffset">#series-gauge.splitLine.lineStyle.dashOffset</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.cap">#series-gauge.splitLine.lineStyle.cap</a>
     * <br/>默认值: 'butt'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String cap;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.join">#series-gauge.splitLine.lineStyle.join</a>
     * <br/>默认值: 'bevel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String join;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.miterLimit">#series-gauge.splitLine.lineStyle.miterLimit</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.shadowBlur">#series-gauge.splitLine.lineStyle.shadowBlur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.shadowColor">#series-gauge.splitLine.lineStyle.shadowColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.shadowOffsetX">#series-gauge.splitLine.lineStyle.shadowOffsetX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影水平方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.shadowOffsetY">#series-gauge.splitLine.lineStyle.shadowOffsetY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影垂直方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-gauge.splitLine.lineStyle.opacity">#series-gauge.splitLine.lineStyle.opacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
