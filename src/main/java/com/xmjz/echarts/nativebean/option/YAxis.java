...
public class YAxis implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#yAxis.alignTicks">https://echarts.apache.org/zh/option.html#yAxis.alignTicks</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>在多个 y 轴为数值轴的时候，可以开启该配置项自动对齐刻度。只对<code class="codespan">'value'</code>和<code class="codespan">'log'</code>类型的轴有效。</p>
     */
