...
public class LabelLayout extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.hideOverlap">#series-sankey.labelLayout.hideOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否隐藏重叠的标签。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.moveOverlap">#series-sankey.labelLayout.moveOverlap</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.x">#series-sankey.labelLayout.x</a>
     * <br/>默认值: 无
    ...
    private Object x;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.y">#series-sankey.labelLayout.y</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","string"]
     * <br/>描述:
    ...
    private Object y;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.dx">#series-sankey.labelLayout.dx</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dx;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.dy">#series-sankey.labelLayout.dy</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    private Integer dy;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.rotate">#series-sankey.labelLayout.rotate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签旋转角度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.width">#series-sankey.labelLayout.width</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.height">#series-sankey.labelLayout.height</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>标签显示的高度。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.align">#series-sankey.labelLayout.align</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.verticalAlign">#series-sankey.labelLayout.verticalAlign</a>
     * <br/>默认值: 无
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.fontSize">#series-sankey.labelLayout.fontSize</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.draggable">#series-sankey.labelLayout.draggable</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-sankey.labelLayout.labelLinePoints">#series-sankey.labelLayout.labelLinePoints</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标签引导线三个点的位置。格式为：</p>
