...
import com.xmjz.echarts.nativebean.option.series.pictorialBarSeries.markPoint.Blur;
import com.xmjz.echarts.nativebean.option.series.pictorialBarSeries.markPoint.Data;
import com.xmjz.echarts.nativebean.option.series.pictorialBarSeries.markPoint.Emphasis;
import com.xmjz.echarts.nativebean.option.series.pictorialBarSeries.markPoint.ItemStyle;
import com.xmjz.echarts.nativebean.option.series.pictorialBarSeries.markPoint.Label;
...
public class MarkPoint extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.symbol">#series-pictorialBar.markPoint.symbol</a>
     * <br/>默认值: 'pin'
     ...
     * </code></pre>
     * <p>其中第一个参数 <code class="codespan">value</code> 为 <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.data">data</a> 中的数据值。第二个参数<code class="codespan">params</code> 是其它的数据项参数。</p>
     */
    private Object symbol;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.symbolSize">#series-pictorialBar.markPoint.symbolSize</a>
     * <br/>默认值: 50
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.symbolRotate">#series-pictorialBar.markPoint.symbolRotate</a>
     * <br/>默认值: 无
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.symbolKeepAspect">#series-pictorialBar.markPoint.symbolKeepAspect</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.symbolOffset">#series-pictorialBar.markPoint.symbolOffset</a>
     * <br/>默认值: [0, 0]
     * <br/>js类型: ["Array"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.silent">#series-pictorialBar.markPoint.silent</a>
     * <br/>默认值: 无
     * <br/>js类型: ["boolean"]
     * <br/>描述:
    ...
    private Label label;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.itemStyle">#series-pictorialBar.markPoint.itemStyle</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标注的样式。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.emphasis">#series-pictorialBar.markPoint.emphasis</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Object"]
     * <br/>描述:
     * <p>标注的高亮样式。</p>
    ...
    private Blur blur;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data">#series-pictorialBar.markPoint.data</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Array"]
     * <br/>描述:
     * <p>标注的数据数组。每个数组项是一个对象，有下面几种方式指定标注的位置。</p>
     * <ol>
     * <li>通过 <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data.x">x</a>, <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data.y">y</a> 属性指定相对容器的屏幕坐标，单位像素，支持百分比。</li>
     * </ol>
     * <ol start="2">
     * <li><p>用 <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data.coord">coord</a> 属性指定数据在相应坐标系上的坐标位置，单个维度支持设置 <code class="codespan">'min'</code>, <code class="codespan">'max'</code>, <code class="codespan">'average'</code>。</p>
     * </li>
     * <li><p>直接用 <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data.type">type</a> 属性标注系列中的最大值，最小值。这时候可以使用 <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data.valueIndex">valueIndex</a> 或者 <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.data.valueDim">valueDim</a> 指定是在哪个维度上的最大值、最小值、平均值。</p>
     * </li>
     * </ol>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animation">#series-pictorialBar.markPoint.animation</a>
     * <br/>默认值: true
     * <br/>js类型: ["boolean"]
     * <br/>描述:
     * <p>是否开启动画。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationThreshold">#series-pictorialBar.markPoint.animationThreshold</a>
     * <br/>默认值: 2000
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationDuration">#series-pictorialBar.markPoint.animationDuration</a>
     * <br/>默认值: 1000
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationEasing">#series-pictorialBar.markPoint.animationEasing</a>
     * <br/>默认值: 'cubicOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationDelay">#series-pictorialBar.markPoint.animationDelay</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationDurationUpdate">#series-pictorialBar.markPoint.animationDurationUpdate</a>
     * <br/>默认值: 300
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
     * <p>数据更新动画的时长。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationEasingUpdate">#series-pictorialBar.markPoint.animationEasingUpdate</a>
     * <br/>默认值: 'cubicInOut'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <p>数据更新动画的缓动效果。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#series-pictorialBar.markPoint.animationDelayUpdate">#series-pictorialBar.markPoint.animationDelayUpdate</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number","Function"]
     * <br/>描述:
