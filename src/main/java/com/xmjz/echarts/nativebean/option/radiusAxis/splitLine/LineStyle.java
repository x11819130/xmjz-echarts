package com.xmjz.echarts.nativebean.option.radiusAxis.splitLine;
...
/**
 * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle">#radiusAxis.splitLine.lineStyle</a>
 * <br/>默认值: 无
 * <br/>js类型: ["Object"]
 * <br/>描述:
 *
...
public class LineStyle extends BaseEcharts implements Serializable {
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.color">#radiusAxis.splitLine.lineStyle.color</a>
     * <br/>默认值: ['#ccc']
     ...
     * <p>示例</p>
     * <pre><code class="hljs javascript">splitLine: {
     *     <span class="hljs-attr">lineStyle</span>: {
     *         <span class="hljs-comment">// 使用深浅的间隔色</span>
     *         <span class="hljs-attr">color</span>: [<span class="hljs-string">'#aaa'</span>, <span class="hljs-string">'#ddd'</span>]
     *     }
     * }
     * </code></pre>
     */
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.width">#radiusAxis.splitLine.lineStyle.width</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>分隔线线宽。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.type">#radiusAxis.splitLine.lineStyle.type</a>
     * <br/>默认值: 'solid'
    ...
    private Object type;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.dashOffset">#radiusAxis.splitLine.lineStyle.dashOffset</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.cap">#radiusAxis.splitLine.lineStyle.cap</a>
     * <br/>默认值: 'butt'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String cap;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.join">#radiusAxis.splitLine.lineStyle.join</a>
     * <br/>默认值: 'bevel'
     * <br/>js类型: ["string"]
     * <br/>描述:
     * <blockquote>
    ...
    private String join;
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.miterLimit">#radiusAxis.splitLine.lineStyle.miterLimit</a>
     * <br/>默认值: 10
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <blockquote>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.shadowBlur">#radiusAxis.splitLine.lineStyle.shadowBlur</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.shadowColor">#radiusAxis.splitLine.lineStyle.shadowColor</a>
     * <br/>默认值: 无
     * <br/>js类型: ["Color"]
     * <br/>描述:
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.shadowOffsetX">#radiusAxis.splitLine.lineStyle.shadowOffsetX</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影水平方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.shadowOffsetY">#radiusAxis.splitLine.lineStyle.shadowOffsetY</a>
     * <br/>默认值: 无
     * <br/>js类型: ["number"]
     * <br/>描述:
     * <p>阴影垂直方向上的偏移距离。</p>
    ...
    /**
     * 官方文档: <a href="https://echarts.apache.org/zh/option.html#radiusAxis.splitLine.lineStyle.opacity">#radiusAxis.splitLine.lineStyle.opacity</a>
     * <br/>默认值: 1
     * <br/>js类型: ["number"]
     * <br/>描述:
